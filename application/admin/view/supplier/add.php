                        ...
                        <form method="post" id="addCustomersForm" class="ajaxForm" action="{:url('add_do')}">
                            ...
                            <table class="table contact-template-form">
                                ...
                                <tr>
                                    ...
                                    <td width="35%"><input type="text" class="form-control w300" name="supplier_short" id="supplier_short"></td>
                                </tr>
                                <tr>
                                    <td width="15%" class="right-color"><span class="text-danger">*</span><span>手机号码:</span></td>
                                    <td width="35%">
                                        <input type="text" class="form-control w300" name="supplier_mobile" id="con_mobile" >
                                    </td>
                                    <td width="15%" class="right-color"><span class="text-danger">*</span><span>联系人:</span></td>
                                    <td width="35%"><input type="text" class="form-control w300" name="supplier_contacts" id="con_duty" ></td>
                                </tr>
                                <tr>
                                    <td width="15%" class="right-color"><span class="text-danger">*</span><span>E-Mail:</span></td>
                                    <td width="35%"><input type="text" class="form-control w300" name="supplier_email" id="con_email"></td>
                                    <td width="15%" class="right-color"><span>部门职务:</span></td>
                                    <td width="35%"><input type="text" class="form-control w300" name="supplier_post" id="con_post" placeholder=""></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><textarea class="form-control" name="supplier_remark" id="con_content" rows="6"></textarea> </td>
                                </tr>
